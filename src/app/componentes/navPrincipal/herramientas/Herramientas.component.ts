...
export class HerramientasComponent implements OnInit, OnChanges {
  ...
  private cargarProductos(): void {
    if (this.tipo) {
      this.mockService.obtenerHerramientas(this.tipo).subscribe(lista => {
