...
export class ProteccionComponent implements OnInit, OnChanges {
    ...
    private cargarProductos(): void {
        if (this.tipo) {
            this.mockService.obtenerProtecciones(this.tipo).subscribe(lista => {
