...
export class SuministrosComponent implements OnInit, OnChanges {
    ...
    */
    private cargarProductos(): void {
        if (this.tipo) {
            this.mockService.obtenerSuministros(this.tipo).subscribe(lista => {
